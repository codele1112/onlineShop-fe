...
const Footer = () => {
  ...
  return (
    <div className="w-full">
      <div className="h-[103px] w-full bg-black flex items-center justify-center  border-b border-black">
        <div className="w-main flex items-center justify-between text-white">
          ...
          <div className=" md:flex-2 flex-1 flex items-center ">
            <input
              type="text"
              className="p-4 md:p-2 pr-0 w-full placeholder:text-main placeholder:text-sm  placeholder:italic placeholder:opacity-50"
              placeholder="Email address"
            />
            <div className="h-[60px] w-[60px] bg-main md:h-[40px]  flex items-center justify-center">
      ...
      <div className="h-[407px] w-full bg-gray-600 text-white flex items-center justify-center text-[13px] lg:px-3">
